...
echo -e "  1. Configure sua chave de API:"
echo -e "       ${YELLOW}nano $INSTALL_DIR/.env${RESET}"
echo -e "     (recomendado: OPENROUTER_API_KEY — tem modelos grátis)"
echo ""
echo -e "  2. Inicie o MWCode:"
echo -e "       ${GREEN}mwcode${RESET}"
echo ""
